...
// // Dummy friends data (same as homepage, expanded)
// const allFriends = [
...
//           </div>
//           <button className="w-10 h-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 active:scale-95 transition">
...
//               <div key={friend.id} className="bg-white rounded-xl p-3 shadow-sm border border-gray-100 active:bg-gray-50 transition flex items-center gap-3">
//                 {/* Avatar */}
//                 <div className="w-12 h-12 rounded-full flex items-center justify-center text-base font-bold shadow-md ring-2 ring-white flex-shrink-0"
...
//                     <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${friend.direction === 'owes' ? 'bg-orange-100 text-orange-600' : 'bg-emerald-100 text-emerald-600'}`}>
//                       {formatBalance(friend.balance)}
//                     </span>
//                   </div>
//                   <p className="text-xs text-gray-500 truncate">{friend.phone}</p>
//                   <div className="flex gap-2 mt-1">
//                     <button className="text-[10px] font-medium text-indigo-500 bg-indigo-50 px-2 py-0.5 rounded-full">Message</button>
//                     <button className="text-[10px] font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full">Settle up</button>
//                   </div>
//                 </div>
//                 {/* More options */}
...
//       {/* Bottom padding to avoid content hidden behind nav */}
